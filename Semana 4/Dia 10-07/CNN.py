...
from tensorflow.keras import layers, models  # Camadas e modelo sequencial #type: ignore
import warnings                              # Para ignorar avisos
warnings.filterwarnings("ignore", category=UserWarning)  # Ignora avisos de usuário
